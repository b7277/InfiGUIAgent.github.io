        ...
        <div class="columns is-centered">
          <div class="column has-text-centered">
            ...
            <div class="is-size-5 publication-authors">
	      	...
	      	<span style="color: #FF0000;">This article was arbitrarily rejected by arXiv, and both appeals and resubmissions have proven ineffective. As a result, the only way to access it at the moment is through the <a href="#" style="text-decoration: none; color: #FF0000;">GitHub repository</a>.</span><br>
