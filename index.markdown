...
<section class="hero" style="margin-bottom: 0px;">
  ...
  <section class="section" style="margin-bottom: 0px !important;">
    <div class="container is-max-desktop">
      <!-- Abstract. -->
